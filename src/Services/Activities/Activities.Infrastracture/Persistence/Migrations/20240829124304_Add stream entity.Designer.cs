...
namespace Activities.Infrastracture.Persistence.Migrations
{
    ...
    [Migration("20240829124304_Add stream entity")]
    partial class Addstreamentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Activities.Domain.Aggregates.Streams.StreamAggregate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Activities.Domain.Aggregates.Streams.StreamAggregate", b =>
                {
                    b.HasOne("Activities.Domain.Aggregates.Activities.ActivityAggregate", null)
                        .WithOne()
                        .HasForeignKey("Activities.Domain.Aggregates.Streams.StreamAggregate", "ActivityId")
