...
public sealed class NewActivityTilesHandler
{
    ...
    private void HandleActivityTilesUpdate(ProcessTilesMessage message, HashSet<Tile> previousTiles, ActivityTilesAggregate activityTiles)
    {
    ...
    private static ActivityTilesAggregate CreateActivityTiles(ProcessTilesMessage message, HashSet<Tile> previousTiles)
    {
    ...
    private bool IsValidToCreate(ProcessTilesMessage message, ActivityTilesAggregate actTiles)
    {
        return !_isCreated && actTiles.CreatedAt > message.CreatedAt;
    }

    private static bool IsActivityLatest(ProcessTilesMessage message, IEnumerable<ActivityTilesAggregate> activityTilesList)
    {
